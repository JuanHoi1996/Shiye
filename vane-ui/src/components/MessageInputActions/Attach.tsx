            ...
            {open && (
              ...
              >
                <motion.div
                  ...
                  className="origin-top-right bg-light-primary dark:bg-dark-primary border rounded-md border-light-200 dark:border-dark-200 w-full max-h-[min(260px,36vh)] flex flex-col overflow-hidden"
                >
