...
- **Drop anything, anywhere** — drag-and-drop files *or* selected text into the message input; the overlay only appears for files so it never blocks a text drop.
...
| **Drag & drop**             | —                                       | Files *and* text; overlay only triggers for files                                                              |
...
| **Export**                  | Markdown + PDF                          | Markdown export + CJK-safe PDF                                                                                 |
